...
define(function(require) {
        ...
        button: function(args) {
            ...
            if (typeof args === 'string') {
                ...
                $.each(args, function(i, val) {
                    ...
                    html +=
                        '<button' + ' type="button"' + ' data-id="' + val.id + '"' + (val.disabled ? ' disabled' : '') + (val.autofocus ? ' autofocus class="ui-dialog-autofocus"' : '') + '>' + val.value + '</button>';
     ...
     * 显示纯文本提示信息
     */
    artDialog.showMsgBox = function(content){
        var _dialog = artDialog.get('dialogMsgBox');
        if (!_dialog) {
            artDialog({
                id: "dialogMsgBox",
            ...
            _dialog.content(content).showModal();
        }
    }
     ...
     * 显示纯文本提示信息
     */
    artDialog.showMsgBoxOkFun = function(content,okLabel,okFun){
        var _dialog = artDialog.get('dialogMsgBox');
        if (!_dialog) {
            artDialog({
                id: "dialogMsgBox",
